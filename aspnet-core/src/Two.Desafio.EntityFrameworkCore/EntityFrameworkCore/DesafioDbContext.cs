...
public class DesafioDbContext :
    AbpDbContext<DesafioDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(DesafioConsts.DbTablePrefix + "YourEntities", DesafioConsts.DbSchema);
        ...
        {
            b.ToTable(DesafioConsts.DbTablePrefix + "Books",
        ...
        {
            b.ToTable(DesafioConsts.DbTablePrefix + "Authors",
                DesafioConsts.DbSchema);
